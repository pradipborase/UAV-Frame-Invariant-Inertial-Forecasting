...
Executed SOS coefficients are copied unchanged from the historical `results/stage1/FILTER_SPECIFICATION.md` audit file. That historical file, and `audit_original/results/stage1/`, retain the original (incorrect) order labels.
